...
def main():
    ...
    if use_augmentation:
        ...
        history = model.fit(X_train, [y_train_g, y_train_a], batch_size=batch_size, epochs=nb_epochs, callbacks=callbacks,
                         validation_data=(X_test, [y_test_g, y_test_a]))
    ...
    np.savez(str(output_dir.joinpath("history2.npz")), history=history.history)
